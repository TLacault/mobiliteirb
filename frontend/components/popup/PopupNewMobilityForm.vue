    ...
    <div class="popup-body">
        <div class="popup-body-center">
            <div class="popup-field">
                <label class="popup-label" for="pm-mobilite">Nommez votre mobilité *</label>
                <input
                    id="pm-mobilite"
                    class="popup-input"
                ...
                />
                <span v-if="errors.mobilite" class="error-message">{{ errors.mobilite }}</span>
            </div>
            ...
            <div class="popup-field">
                ...
                />
                <span v-if="errors.depart" class="error-message">{{ errors.depart }}</span>
            </div>
            ...
            <div class="popup-field">
                ...
                />
                <span v-if="errors.arrivee" class="error-message">{{ errors.arrivee }}</span>
            </div>
        </div>

        <div class="popup-toggle-row">
            <div class="popup-toggle-column-left">
                <span class="popup-toggle-label">Visibilité</span>
            </div>
            <div class="popup-toggle-column-right">
                ...
                <span class="popup-toggle-label">
                    {{ form.visibilite ? 'Publique' : 'Privée' }}
                </span>
            </div>
        </div>
    </div>
