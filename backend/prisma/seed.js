...
async function main() {
  ...
  // Clean database (respects cascade deletes)
  ...
  // Random number of users (between 5 and 15)
  ...
  for (const user of users) {
    ...
    for (let m = 0; m < mobilityCount; m++) {
      ...
      // Each mobility has 1-4 trips (different route options)
  ...
  console.log(`  🚌 Transport Modes: ${totalTransportModes}`);
